...
const GetInTouch = () => {
  return (
    <div className="m-20">
      <div className=" max-h-[432px] relative  rounded-2xl bg-[#F7FAFE] py-24 flex flex-col items-center">
        ...
        <div className="absolute left-[-20px]  bottom-[20%]">
          <svg
            width="40"
            height="40"
            viewBox="0 0 40 40"
        ...
        <h1 className=" text-[64px] text-[#2E2E2E] text-center  font-bold leading-[88px]">
          We're here to make your <br /> website awesome.
        </h1>
        <button className=" py-3 px-4 rounded-lg flex  gap-2 bg-[#B00000] text-white justify-center items-center  w-80">
          <svg
            width="25"
            height="25"
            viewBox="0 0 25 25"
