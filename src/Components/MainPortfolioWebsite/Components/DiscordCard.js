...
const DiscordCard = () => {
  return (
    <div
      className={`w-full flex text-white  flex-col gap-6 justify-center items-center py-10 rounded-sm px-12`}
    >
      <h1 className="font-bold  text-white  text-4xl">
        Join Atiq on Discord
      </h1>
      <p className=" font-normal text-base mt-4">
        Join the Atiq Discord server to get help with your coding
        questions, find coding buddies, and get updates on new courses and
        projects.
      </p>
      ...
      <button className="group relative w-full flex justify-center py-4 px-4 border border-transparent text-md font-medium rounded-md text-white bg-sky-500 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">
        <svg
          stroke="currentColor"
          fill="currentColor"
          stroke-width="0"
          viewBox="0 0 24 24"
          class="h-5 w-5 text-white group-hover:text-gray-300"
          aria-hidden="true"
          height="1em"
          width="1em"
        ...
        <span class="ml-2">Join the Discord Server</span>
      </button>
    </div>
  );
};
