...
const ResuableContentBox = ({ head, conent, buttonText,mwidth,style }) => {
  return (
    <div className={`absolute ${style} w-96  py-3.5 px-4 w-[${mwidth}] m-auto reuseablebox text-white flex flex-col justify-start gap-2 shrink-0 items-start rounded-3xl  bg-gradient-[180deg, rgba(255, 255, 255, 0.40) 0%, rgba(255, 255, 255, 0.20) 100%] shadow-3xl`}>
      <h3>{head}</h3>
